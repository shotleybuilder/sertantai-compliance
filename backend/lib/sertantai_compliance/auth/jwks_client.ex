defmodule SertantaiCompliance.Auth.JwksClient do
  @moduledoc """
  ...
  is disabled but the service continues.
  """
  ...
  def handle_info(:fetch, state) do
    case fetch_jwks() do
      ...
      {:error, :no_auth_url} ->
        Logger.info("auth_url not configured — running without JWKS")
        {:noreply, state}
  ...
  defp req_plug do
    Application.get_env(:sertantai_compliance, :jwks_req_plug)
  end
end
