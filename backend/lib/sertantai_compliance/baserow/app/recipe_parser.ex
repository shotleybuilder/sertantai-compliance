defmodule SertantaiCompliance.Baserow.App.RecipeParser do
  @moduledoc """
  ...
  """
  def load_all do
    recipe_path = Application.app_dir(:sertantai_compliance, @recipe_dir)
  ...
  def load(key) when is_atom(key) do
    filename = "#{key}.yml"
    path = Application.app_dir(:sertantai_compliance, Path.join(@recipe_dir, filename))
