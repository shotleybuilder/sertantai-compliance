defmodule SertantaiComplianceWeb.TemplateWebhookController do
  @moduledoc """
  ...
  alias SertantaiCompliance.Sync.Providers.Baserow
  alias SertantaiCompliance.Sync.Templates.{ComplianceMetrics, WebhookEvent}
