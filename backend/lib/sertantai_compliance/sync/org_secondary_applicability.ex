defmodule SertantaiCompliance.Sync.OrgSecondaryApplicability do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :status, SertantaiCompliance.Sync.ApplicabilityStatus do
      allow_nil?(false)
      default(:unreviewed)
      description("Applicability decision: yes, no, excluded, unreviewed")
    end

    attribute :source, SertantaiCompliance.Sync.SecondaryApplicabilitySource do
      allow_nil?(false)
  ...
  actions do
    ...
    read :by_organization_and_status do
      argument(:organization_id, :uuid, allow_nil?: false)
      argument(:status, SertantaiCompliance.Sync.ApplicabilityStatus, allow_nil?: false)
