...
1. **Agree the session title and scope** with the user. The title should be short and descriptive — "Baserow Sync Fix", "Electric Proxy Routing", "Screening Profile UI". Not a task description. If a GitHub Issue is provided, include the issue number in the filename.
