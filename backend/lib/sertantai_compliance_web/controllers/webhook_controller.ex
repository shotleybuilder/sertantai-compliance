defmodule SertantaiComplianceWeb.WebhookController do
  @moduledoc """
  ...
  defp upsert_entitlement(attrs) do
    Ash.create(SertantaiCompliance.Sync.OrgEntitlement, attrs, action: :upsert)
  end

  defp validate_profiles(entitlement) do
    entitled_families = MapSet.new(entitlement.families)

    case Ash.read(SertantaiCompliance.Sync.SyncProfile,
