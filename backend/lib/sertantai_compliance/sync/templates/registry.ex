defmodule SertantaiCompliance.Sync.Templates.Registry do
  @moduledoc """
  ...
  def all do
    %{
      customers: SertantaiCompliance.Sync.Templates.Customers,
      foundation: SertantaiCompliance.Sync.Templates.Foundation,
      personnel: SertantaiCompliance.Sync.Templates.Personnel,
      compliance_assessment: SertantaiCompliance.Sync.Templates.ComplianceAssessment,
      action_tracker: SertantaiCompliance.Sync.Templates.ActionTracker,
      evidence_vault: SertantaiCompliance.Sync.Templates.EvidenceVault,
      incident_register: SertantaiCompliance.Sync.Templates.IncidentRegister,
      audit_management: SertantaiCompliance.Sync.Templates.AuditManagement,
      training_tracker: SertantaiCompliance.Sync.Templates.TrainingTracker,
      document_control: SertantaiCompliance.Sync.Templates.DocumentControl,
      raci: SertantaiCompliance.Sync.Templates.RACI,
      pdca: SertantaiCompliance.Sync.Templates.PDCA,
      org_structure: SertantaiCompliance.Sync.Templates.OrgStructure,
      hierarchy: SertantaiCompliance.Sync.Templates.Hierarchy,
      controls: SertantaiCompliance.Sync.Templates.Controls,
      control_mappings: SertantaiCompliance.Sync.Templates.ControlMappings,
      evidence_patterns: SertantaiCompliance.Sync.Templates.EvidencePatterns,
      artefact_templates: SertantaiCompliance.Sync.Templates.ArtefactTemplates,
      artefacts: SertantaiCompliance.Sync.Templates.Artefacts,
      judgements: SertantaiCompliance.Sync.Templates.Judgements,
      gaps: SertantaiCompliance.Sync.Templates.Gaps,
      compliance_events: SertantaiCompliance.Sync.Templates.ComplianceEvents,
      app_users: SertantaiCompliance.Sync.Templates.AppUsers
    }
  end
