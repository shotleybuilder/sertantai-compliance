defmodule SertantaiCompliance.Sync.SyncRowMapping do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :source_type, SertantaiCompliance.Sync.SourceType do
      allow_nil?(false)
  ...
  actions do
    ...
    read :by_configuration_and_type do
      argument(:sync_configuration_id, :uuid, allow_nil?: false)
      argument(:source_type, SertantaiCompliance.Sync.SourceType, allow_nil?: false)
  ...
  relationships do
    belongs_to :sync_configuration, SertantaiCompliance.Sync.SyncConfiguration do
