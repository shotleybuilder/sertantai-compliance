defmodule SertantaiCompliance.Sync.Templates.CompliancePoller do
  @moduledoc """
  ...
  alias SertantaiCompliance.Sync.Templates.ComplianceMetrics
  ...
  defp poll_assessment_counts(config, table_id) do
    _provider = SertantaiCompliance.Sync.Providers.Baserow
