<script lang="ts">
	...
	const amendedLawsGrouping: GroupConfig[] = [
		{ column: 'latest_amend_date_year' },
		{ column: 'latest_amend_date_month' }
	];
	const amendedLawsLiveFilter: FilterCondition = {
		id: 'live-filter',
		field: 'live',
		operator: 'equals',
		value: '✔ In force'
	...
	const repealedLawsGrouping: GroupConfig[] = [
		{ column: 'latest_rescind_date_year' },
		{ column: 'latest_rescind_date_month' }
	];
	const repealedLawsLiveFilter: FilterCondition = {
		id: 'live-filter',
		field: 'live',
		operator: 'equals',
	...
	const defaultViews: ViewDef[] = [
		...
		{
			name: 'This Month',
			description: 'Laws from this calendar month onwards.',
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [{ id: 'f1', field: 'md_date', operator: 'is_after', value: thisMonthStart }],
				sorting: newLawsSorting,
		...
		},
		{
			...
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [
					{ id: 'f1', field: 'md_date', operator: 'is_after', value: lastMonthStart },
					{ id: 'f2', field: 'md_date', operator: 'is_before', value: thisMonthStart }
				],
				sorting: newLawsSorting,
				grouping: newLawsGrouping
			})
		...
		{
			name: 'This Quarter',
			description: 'Laws from this calendar quarter onwards.',
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [{ id: 'f1', field: 'md_date', operator: 'is_after', value: thisQuarterStart }],
				sorting: newLawsSorting,
				grouping: newLawsGrouping
			})
		},
		{
			...
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [
					{ id: 'f1', field: 'md_date', operator: 'is_after', value: lastQuarterStart },
					{ id: 'f2', field: 'md_date', operator: 'is_before', value: thisQuarterStart }
				],
				sorting: newLawsSorting,
				grouping: newLawsGrouping
			})
		...
		{
			name: 'This Year',
			description: 'Laws from this calendar year onwards.',
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [{ id: 'f1', field: 'md_date', operator: 'is_after', value: thisYearStart }],
				sorting: newLawsSorting,
				grouping: newLawsGrouping
			})
		},
		{
			...
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [
					{ id: 'f1', field: 'md_date', operator: 'is_after', value: lastYearStart },
					{ id: 'f2', field: 'md_date', operator: 'is_before', value: thisYearStart }
				],
				sorting: newLawsSorting,
				grouping: newLawsGrouping
			})
		},
		{
			...
			config: makeViewConfig({
				visibleCols: newLawsColumns,
				filters: [
					{ id: 'f1', field: 'md_date', operator: 'is_after', value: threeYearsAgoStart },
					{ id: 'f2', field: 'md_date', operator: 'is_before', value: todayStr }
				],
				sorting: newLawsSorting,
				grouping: newLawsGrouping
			})
		...
		// Amended Laws
		{
			...
			description: 'Laws amended this month (in force).',
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: thisMonthStart },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
			})
		},
		{
			name: 'Amended Last Month',
			description: 'Laws amended last month (in force).',
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: lastMonthStart },
					{ id: 'f2', field: 'latest_amend_date', operator: 'is_before', value: thisMonthStart },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
		...
		},
		{
			...
			description: 'Laws amended this quarter (in force).',
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: thisQuarterStart },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
		...
		},
		{
			...
			description: 'Laws amended last quarter (in force).',
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: lastQuarterStart },
					{ id: 'f2', field: 'latest_amend_date', operator: 'is_before', value: thisQuarterStart },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
		...
		},
		{
			...
			description: 'Laws amended this year (in force).',
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: thisYearStart },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
		...
		},
		{
			...
			description: `Laws amended in ${currentYear - 1} (in force).`,
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: lastYearStart },
					{ id: 'f2', field: 'latest_amend_date', operator: 'is_before', value: thisYearStart },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
		...
		},
		{
			...
			description: `Laws amended from ${currentYear - 3} to today (in force).`,
			config: makeViewConfig({
				visibleCols: amendedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_amend_date', operator: 'is_after', value: threeYearsAgoStart },
					{ id: 'f2', field: 'latest_amend_date', operator: 'is_before', value: todayStr },
					amendedLawsLiveFilter
				],
				sorting: amendedLawsSorting,
				grouping: amendedLawsGrouping
		...
		// Repealed Laws
		{
			...
			description: 'Laws repealed/revoked this month.',
			config: makeViewConfig({
				visibleCols: repealedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_rescind_date', operator: 'is_after', value: thisMonthStart },
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
				grouping: repealedLawsGrouping
			})
		},
		{
			name: 'Repealed Last Month',
			description: 'Laws repealed/revoked last month.',
			config: makeViewConfig({
				visibleCols: repealedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_rescind_date', operator: 'is_after', value: lastMonthStart },
					{ id: 'f2', field: 'latest_rescind_date', operator: 'is_before', value: thisMonthStart },
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
				grouping: repealedLawsGrouping
		...
		},
		{
			...
			description: 'Laws repealed/revoked this quarter.',
			config: makeViewConfig({
				visibleCols: repealedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_rescind_date', operator: 'is_after', value: thisQuarterStart },
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
				grouping: repealedLawsGrouping
		...
		},
		{
			...
			description: 'Laws repealed/revoked last quarter.',
			config: makeViewConfig({
				visibleCols: repealedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_rescind_date', operator: 'is_after', value: lastQuarterStart },
					{
						id: 'f2',
						field: 'latest_rescind_date',
						operator: 'is_before',
						value: thisQuarterStart
					},
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
		...
		},
		{
			...
			description: 'Laws repealed/revoked this year.',
			config: makeViewConfig({
				visibleCols: repealedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_rescind_date', operator: 'is_after', value: thisYearStart },
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
				grouping: repealedLawsGrouping
		...
		},
		{
			...
			config: makeViewConfig({
				visibleCols: repealedLawsColumns,
				filters: [
					{ id: 'f1', field: 'latest_rescind_date', operator: 'is_after', value: lastYearStart },
					{ id: 'f2', field: 'latest_rescind_date', operator: 'is_before', value: thisYearStart },
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
				grouping: repealedLawsGrouping
				...
				filters: [
					{
						...
						field: 'latest_rescind_date',
						operator: 'is_after',
						value: threeYearsAgoStart
					},
					{ id: 'f2', field: 'latest_rescind_date', operator: 'is_before', value: todayStr },
					repealedLawsLiveFilter
				],
				sorting: repealedLawsSorting,
				grouping: repealedLawsGrouping
		...
		// Classification
		{
			...
			config: makeViewConfig({
				visibleCols: ['name', 'title_en', 'family', 'family_ii', 'year', 'type_code', 'live'],
				sorting: [{ column: 'family', direction: 'asc' }],
				grouping: [{ column: 'family' }]
			})
		},
		{
			name: 'By Status',
			description: 'Laws grouped by current status.',
			config: makeViewConfig({
				visibleCols: ['name', 'title_en', 'live', 'year', 'type_code', 'md_date', 'family'],
				sorting: [{ column: 'md_date', direction: 'desc' }],
				grouping: [{ column: 'live' }]
			})
		},
		{
			name: 'By Type',
			description: 'Laws grouped by legislation type.',
			config: makeViewConfig({
				visibleCols: ['name', 'title_en', 'type_code', 'type_class', 'year', 'live', 'md_date'],
				sorting: [{ column: 'md_date', direction: 'desc' }],
				grouping: [{ column: 'type_code' }]
			})
		},
		{
			name: 'Geographic Scope',
			description: 'Laws by geographic extent.',
			config: makeViewConfig({
				visibleCols: ['name', 'title_en', 'geo_extent', 'geo_region', 'year', 'type_code', 'live'],
				sorting: [{ column: 'md_date', direction: 'desc' }],
				grouping: [{ column: 'geo_extent' }]
			})
		}
	];
	...
	for (const v of defaultViews) {
		viewToGroupName[v.name] = viewGroupMapping[v.name]
			? ({
					'new-laws': 'New Laws',
					'amended-laws': 'Amended Laws',
					'repealed-laws': 'Repealed Laws',
					classification: 'Classification'
				}[viewGroupMapping[v.name]] ?? 'New Laws')
			: 'New Laws';
	}
							...
							<div class="mb-6">
								<div class="flex items-start gap-3 mb-2">
									{#if familyDisplay.prefix}
										<span
											class="inline-block px-2 py-1 text-sm font-medium rounded {familyDisplay.prefix ===
											'HS'
												? 'bg-blue-100 text-blue-700'
												: familyDisplay.prefix === 'E'
													? 'bg-green-100 text-green-700'
													: 'bg-purple-100 text-purple-700'}"
										>
								...
								<div class="flex flex-wrap gap-2 mt-3">
									{#if r.live}
										<span
											class="inline-flex px-2 py-0.5 text-xs font-medium rounded {r.live === 'Live'
												? 'bg-green-100 text-green-800'
												: r.live === 'Revoked'
													? 'bg-red-100 text-red-800'
													: 'bg-gray-100 text-gray-800'}">{r.live}</span
										>
									{/if}
									{#if fns?.length}
										{#each fns as fn}
											<span
												class="px-2 py-0.5 text-xs rounded {fn === 'Making'
													? 'bg-green-100 text-green-700'
													: fn === 'Amending'
														? 'bg-yellow-100 text-yellow-700'
														: fn === 'Revoking'
															? 'bg-red-100 text-red-700'
															: 'bg-gray-100 text-gray-700'}">{fn}</span
											>
										{/each}
									{/if}
									{#if r.leg_gov_uk_url}
								...
								<section class="bg-gray-50 rounded-lg p-4">
									...
									<dl class="space-y-2">
										<div class="flex justify-between">
											...
											<dd class="text-sm font-medium text-gray-900">{r.year}</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Number</dt>
											<dd class="text-sm font-medium text-gray-900">{r.number || '-'}</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Type Code</dt>
											<dd class="text-sm font-medium text-gray-900 uppercase">
												{r.type_code || '-'}
											</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Type Class</dt>
											<dd class="text-sm font-medium text-gray-900">{r.type_class || '-'}</dd>
										</div>
									</dl>
								</section>
								<section class="bg-gray-50 rounded-lg p-4">
									...
									<dl class="space-y-2">
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Family</dt>
											<dd class="text-sm font-medium text-gray-900">{r.family || '-'}</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Family II</dt>
											<dd class="text-sm font-medium text-gray-900">{r.family_ii || '-'}</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">SI Code</dt>
											<dd class="text-sm font-medium text-gray-900">{r.si_code || '-'}</dd>
										</div>
									</dl>
								</section>
								<section class="bg-gray-50 rounded-lg p-4">
									...
									<dl class="space-y-2">
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Extent</dt>
											<dd class="text-sm font-medium text-gray-900">{r.geo_extent || '-'}</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Region</dt>
											<dd class="text-sm font-medium text-gray-900">{r.geo_region || '-'}</dd>
										</div>
									</dl>
								</section>
								<section class="bg-gray-50 rounded-lg p-4">
									...
									<dl class="space-y-2">
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Primary Date</dt>
											<dd class="text-sm font-medium text-gray-900">
												{formatDate(asStr(r.md_date))}
											</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Made</dt>
											<dd class="text-sm font-medium text-gray-900">
												{formatDate(asStr(r.md_made_date))}
											</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">In Force</dt>
											<dd class="text-sm font-medium text-gray-900">
												{formatDate(asStr(r.md_coming_into_force_date))}
											</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Last Amended</dt>
											<dd class="text-sm font-medium text-gray-900">
												{formatDate(asStr(r.latest_amend_date))}
											</dd>
										</div>
										<div class="flex justify-between">
											<dt class="text-sm text-gray-600">Last Rescinded</dt>
											<dd class="text-sm font-medium text-gray-900">
												{formatDate(asStr(r.latest_rescind_date))}
											</dd>
										</div>
									</dl>
								</section>
