defmodule SertantaiCompliance.Sync.Workers.SyncWorker do
  @moduledoc """
  ...
  alias SertantaiCompliance.Sync.Engine
  ...
  defp load_and_validate_config(config_id) do
    case Ash.get(SertantaiCompliance.Sync.SyncConfiguration, config_id) do
      {:ok, config} ->
