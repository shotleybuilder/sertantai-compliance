defmodule SertantaiComplianceWeb.SyncController do
  @moduledoc """
  ...
  alias SertantaiCompliance.Sync.{Credentials, ProfileQuery}
  alias SertantaiCompliance.Sync.Workers.SyncWorker
  ...
  def test_connection(conn, %{"id" => id}) do
    with {:ok, config} <- Ash.get(Sync.SyncConfiguration, id),
      ...
      case SertantaiCompliance.Sync.Providers.Baserow.test_connection(provider_config) do
