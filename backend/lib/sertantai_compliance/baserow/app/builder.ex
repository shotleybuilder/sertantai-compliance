defmodule SertantaiCompliance.Baserow.App.Builder do
  @moduledoc """
  ...
  ## Usage
      ...
      SertantaiCompliance.Baserow.App.Builder.build(sync_config_id)
  ...
  alias SertantaiCompliance.Baserow.App.{RecipeParser, FieldResolver, PageBuilder}
  alias SertantaiCompliance.Sync.{Credentials, SyncConfiguration}
  alias SertantaiCompliance.Sync.Providers.Baserow, as: BaserowProvider
